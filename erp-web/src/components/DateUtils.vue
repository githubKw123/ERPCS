<template >
    <div style="padding: 30px;font-size: 25px;">
      <div>
        <span class="time" style="width: 100%" id="time" >
      ...
      <div style="font-size: 20px;">
        距离下班还有
        <span class="hour" style="margin-left: 5px;">{{17-time.hour}}</span>
        <a>小时</a>
        <span class="minitus">{{59-time.minitus}}</span>
        <a>分钟</a>
        <span class="seconds">{{60-time.seconds}}</span>
        <a>秒</a>
      </div>
      <div style="font-size: 20px;">
        <span>认真工作不摸鱼 老板青桔变宾利</span>
      </div>
