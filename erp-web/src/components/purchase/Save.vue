        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="缺货仓库"
                          prop="warehouseName">
              <el-input v-model="saveProductForm.warehouseName"
                        disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="购货数量"
                          prop="quantity">
              <el-input v-model="saveProductForm.quantity"
                        @change="dochange()"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="购货单价"
                          prop="price">
              <el-input v-model="saveProductForm.price"
                        @change="dochange()"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    handleCurrentChange(saleList) {
      ...
      this.saveProductForm.warehouseId = saleList.warehouseId
      this.saveProductForm.warehouseName = saleList.warehouseName
    ...
    dochange() {
      this.saveProductForm.amount = this.saveProductForm.quantity * this.saveProductForm.price
      console.log(this.saveProductForm.amount)
    }
  }
}
</script>
